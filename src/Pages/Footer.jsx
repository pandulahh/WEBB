					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/pandulahh/" class="hover:underline">
										PANDU
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/smauiiofficial/" class="hover:underline">
										Butuh partner
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/cal1xteez/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X I UNGGULAN | Di Kelola Oleh Siswa X I
						</p>
					</div>
				</div>
			</div>
